/**
 * VENDORED COPY of src/domain/strategyParams.ts for the Next.js bundle (Turbopack cannot import outside dashboard/).
 * When you change ORB params validation in the bot repo, update this file to match.
 */
import { z } from "zod";
