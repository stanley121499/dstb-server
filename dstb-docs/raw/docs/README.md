...
├── docs/              # Stub pointer → see dstb-docs/
└── dstb-docs/         # LLM Wiki vault: raw/docs/ = this markdown tree; wiki/ = synthesis
```
...
- **This folder (`dstb-docs/raw/docs/`) is the canonical doc archive.** The navigable wiki layer lives in `dstb-docs/wiki/` (see repo `CLAUDE.md`). Code implements what docs specify.
